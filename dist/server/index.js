globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/KirakiraTypingApp-CFcwbnbM.js","assets/layout-segment-context-CtU-jKrd.js"];
...
function getDraftSecret() {
	return "b41cca54-b006-4884-8519-7e23879249d1";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "5538384d-8dec-4594-8e3d-ec87cd2f968d";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "5538384d-8dec-4594-8e3d-ec87cd2f968d") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "5538384d-8dec-4594-8e3d-ec87cd2f968d",
		rootBoundaryId
	});
}
/**
...
var KirakiraTypingApp = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'KirakiraTypingApp' is called on server");
}, "cce34dd8c55d", "KirakiraTypingApp");
//#endregion
//#region app/page.tsx
var page_exports = /* @__PURE__ */ __exportAll({ default: () => Home });
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(KirakiraTypingApp, {});
}
