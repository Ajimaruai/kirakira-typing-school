...
export const avatarItems: AvatarItem[] = [
  { itemId: "hair-bob", category: "hair", name: "ましゅまろボブ", icon: "☁️", rarity: "starter", price: 0, ownedByDefault: true, unlockCondition: { type: "always" }, rewardType: "shop", visualType: "layeredImage", visualConfig: { styleKey: "bob", accent: "#6d4553", thumbnailSrc: "/assets/avatar/thumbnails/hair-bob.svg", layers: [{ slot: "hairFront", src: "/assets/avatar/hair/hair-bob.svg" }] }, description: "まるくてやわらかな定番ボブ" },
  ...
  { itemId: "outfit-uniform", category: "outfit", name: "リボン制服", icon: "🎓", rarity: "starter", price: 0, ownedByDefault: true, unlockCondition: { type: "always" }, rewardType: "shop", visualType: "layeredImage", visualConfig: { styleKey: "uniform", thumbnailSrc: "/assets/avatar/thumbnails/outfit-uniform.svg", layers: [{ slot: "outfit", src: "/assets/avatar/outfits/outfit-uniform.svg" }] }, description: "大きなリボンの学園制服" },
  ...
  { itemId: "shoes-brown", category: "shoes", name: "ふわふわルームシューズ", icon: "🧸", rarity: "starter", price: 0, ownedByDefault: true, unlockCondition: { type: "always" }, rewardType: "shop", visualType: "layeredImage", visualConfig: { styleKey: "brown", thumbnailSrc: "/assets/avatar/thumbnails/shoes-brown.svg", layers: [{ slot: "shoes", src: "/assets/avatar/shoes/shoes-brown.svg" }] }, description: "やわらかくて歩きやすい靴" },
  ...
  { itemId: "accessory-none", category: "accessory", name: "アクセなし", icon: "✨", rarity: "starter", price: 0, ownedByDefault: true, unlockCondition: { type: "always" }, rewardType: "shop", visualType: "layeredImage", visualConfig: { styleKey: "none", thumbnailSrc: "/assets/avatar/thumbnails/accessory-none.svg", layers: [{ slot: "accessory", src: "/assets/avatar/accessories/accessory-none.svg" }] }, description: "アクセサリーを外します" },
